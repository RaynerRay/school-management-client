...
const ContactUs: React.FC = () => {
  ...
  const [selectedRole, setSelectedRole] = useState<any>(roles[0]);// eslint-disable-line @typescript-eslint/no-explicit-any
  const [selectedMedia, setMedia] = useState<any>(media[0]);// eslint-disable-line @typescript-eslint/no-explicit-any
