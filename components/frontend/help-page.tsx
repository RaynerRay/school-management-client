...
const faqs = [
  {
    question: "What is SchoolTech?",
    answer:
      "SchoolTech is a comprehensive online school management system designed to streamline educational administration. It provides tools for managing admissions, student information, scheduling, grading, and more—all accessible anytime, anywhere through the internet.",
  },
  {
    question: "Can SchoolTech adapt to my school's unique requirements?",
    answer:
      "Yes! SchoolTech is highly flexible and can be adapted to various educational systems. You can customize grading criteria, class levels, timetables, and report cards within minutes. We'll help you set everything up during your free trial period.",
  },
  {
    question: "What are the system requirements for using SchoolTech?",
    answer:
      "SchoolTech is web-based and requires only a modern web browser that supports HTML5, such as Google Chrome, Mozilla Firefox, or Microsoft Edge. No additional software installation is needed.",
  },
  {
    question: "How can I migrate my existing school data to SchoolTech?",
    answer:
      "SchoolTech provides a simple data migration process. You can import your existing data using Microsoft Excel (.xls) files. Our system offers a step-by-step guide to ensure smooth data transfer.",
  },
  {
    question: "What kind of support does SchoolTech offer?",
    answer:
  ...
  {
    question: "Do I need expensive training to use SchoolTech?",
    answer:
      "No. SchoolTech is designed with an intuitive interface that's easy to use from day one. We provide free access to video tutorials and documentation. Our support team is also available to guide you through any features you need help with.",
  },
  {
    question: "How much does SchoolTech cost?",
    answer:
  ...
  {
    question: "How does SchoolTech ensure my school's data security?",
    answer:
  ...
  {
    question: "Can SchoolTech be installed on our school's servers?",
    answer:
      "SchoolTech is a cloud-based solution, which means you don't need to worry about server maintenance, updates, or backups. This allows us to provide continuous upgrades, reliable service, and immediate support to all users.",
  },
  {
