...
export default function SearchBar({
  ...
  onSearch: any;// eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const filteredData = data.filter((item: any) =>// eslint-disable-line @typescript-eslint/no-explicit-any
